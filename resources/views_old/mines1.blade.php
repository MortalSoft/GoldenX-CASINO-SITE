				...
				<div class="col-lg-5">
					...
					<div class="flex no_padding wrap" style="margin-top:10px">
						<div class="col-5">
							...
							<div style="position:relative;">
								<input type="" class="secodary_input input_wheel" onkeyup="updateMinesX()"  value="1.00" id="BetMines" name="">
								<div class="dop_input">
						...
						<div class="col-5" >
							<div class="flex no_padding wrap">
								<div class="col-5">
									<button class="btn_bet btn_mine_bomb" onclick="$('#BetMines').val((Number($('#BetMines').val()) * 2).toFixed(2));updateMinesX()" style="margin-top:0px">x2</button>
								</div>
								<div class="col-5">
									<button class="btn_bet btn_mine_bomb" onclick="$('#BetMines').val(Number($('#balance').attr('balance')).toFixed(2));updateMinesX()" style="margin-top:0px">max</button>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="flex no_padding wrap" style="margin-top:10px">
						<div class="col-5" style="width:70px;max-width:70px;">
							...
							<div style="position:relative;">
								<input type="" class="secodary_input input_wheel" onkeyup="updateMinesX()" id="BombMines" value="3" min="2" max="25" name="">
								<div class="dop_input">
						...
						<div class="col-5" style="width:calc(100% - 75px);max-width:100%;">
							<div class="flex no_padding wrap" >
								<div class="col-5" style="width:calc(100% / 4 - 5px);max-width:calc(100 / 4 - 5px);">
									<button class="btn_bet btn_mine_bomb bomb_3 active" onclick="$('#BombMines').val(3);updateMinesX()" style="margin-top:0px">3</button>
								</div>
								<div class="col-5" style="width:calc(100% / 4 - 5px);max-width:calc(100 / 4 - 5px);">
									<button class="btn_bet btn_mine_bomb bomb_5" onclick="$('#BombMines').val(5);updateMinesX()" style="margin-top:0px">5</button>
								</div>
								<div class="col-5" style="width:calc(100% / 4 - 5px);max-width:calc(100 / 4 - 5px);">
									<button class="btn_bet btn_mine_bomb bomb_10" onclick="$('#BombMines').val(10);updateMinesX()" style="margin-top:0px">10</button>
								</div>
								<div class="col-5" style="width:calc(100% / 4 - 5px);max-width:calc(100 / 4 - 5px);">
									<button class="btn_bet btn_mine_bomb bomb_24" onclick="$('#BombMines').val(24);updateMinesX()" style="margin-top:0px">24</button>
								</div>
							</div>
						</div>
					</div>

					<button class="btn_bet_dice start_block_mine w-100" style="margin-top:20px" onclick="disable(this);startGameMine(this)">Играть <img class="dop_btn" src="img/yellow_coin.svg"> </button>



					<div class="flex no_padding play_block_mine wrap" style="display:none">
						<div class="col-5">
							<button class="btn_bet_dice w-100" style="margin-top:20px" onclick="disable(this);$('.mine').addClass('no_select');finishGameMine(this)">Забрать <span id="winMine">0.00</span><img class="dop_btn" src="img/yellow_coin.svg"> </button>
						</div>
						<div class="col-5">
							<button class="btn_bet_dice w-100" style="margin-top:20px" onclick="disable(this);$('.mine').addClass('no_select');autoClickMine(this)">Автовыбор </button>
						</div>
					</div>

					<div style="height:40px;margin-bottom: 15px;"><button class="btn-dep w-100" style="margin-top:15px;display: none;" id="checkMine" onclick="checkMine()">Проверить игру</button></div>
					...
					<center>
						<div class="block">
							<div class="wrapper">
								...
								@for ($i = 0; $i < 25; $i++)
								<div class="mine" onclick="disable(this);$('.mine').addClass('no_select');clickMine(this, {{($i + 1)}})"><img class="mine_img win hide" src="img/mine_img_win.png" ><img class="mine_img lose hide" src="img/mine_img_lose.png" ></div>
								@endfor
